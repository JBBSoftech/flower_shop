...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/flower_shop_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '69257132848b7a78482dca18',
...
app.listen(PORT, () => {
  console.log(`Flower Shop Backend Server running on port ${PORT}`);
});
