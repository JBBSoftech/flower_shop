...
class AdminManager {
  ...
  static Future<String> getCurrentAdminId() async {
    ...
    try {
      ...
      if (ApiConfig.adminObjectId != '69257132848b7a78482dca18') {
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _loadDynamicData();
    // Commenting out auto-refresh to prevent blinking
    // _startAutoRefresh();
  ...
  // Auto-refresh every 5 minutes instead of 5 seconds
  ...
  Future<void> _loadDynamicAppConfig({bool showLoading = false}) async {
    try {
      // Get dynamic admin ID
      final adminId = await AdminManager.getCurrentAdminId();
